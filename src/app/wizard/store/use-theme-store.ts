...
export const useThemeStore = create<ThemeStore>()(
  persist(
    (set) => ({
      ...
      setSelectedColor: (color) => set({ selectedColor: color, generatedCSS: null }),

      setSelectedScheme: (scheme) => set({ selectedScheme: scheme, generatedCSS: null }),
      ...
      updateSettings: (settings) =>
        set((state) => ({
          ...state,
          ...settings,
          generatedCSS: settings.generatedCSS !== undefined ? settings.generatedCSS : null,
        })),
