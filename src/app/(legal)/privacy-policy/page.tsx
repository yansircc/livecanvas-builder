				...
				<main className="container flex-1 py-12">
					<div className="mx-auto max-w-4xl space-y-8 px-4">
						...
						<div className="prose prose-zinc dark:prose-invert max-w-none">
							<p className="lead">
								我们非常重视你的隐私。本隐私政策描述了我们收集、使用、披露和保护你在使用我们的服务时提供的信息的方式。
							</p>
							...
							<ul>
								<li>
									<strong>个人信息：</strong>{" "}
									包括你的姓名、电子邮件地址、个人资料照片等你在注册和使用我们的服务时提供的信息。
								</li>
								<li>
								...
								<li>
									<strong>使用数据：</strong>{" "}
									关于你如何使用我们的服务的信息，包括你创建的内容、浏览历史、点击行为等。
								</li>
								<li>
									<strong>设备信息：</strong>{" "}
									包括你的IP地址、浏览器类型、操作系统、设备标识符等技术信息。
								</li>
								<li>
							...
							<ul>
								...
								<li>
									<strong>经你同意：</strong> 在你同意的情况下与其他方共享。
								</li>
							</ul>

							<h2>4. 数据安全</h2>
							<p>
								我们采取合理的安全措施来保护你的信息免受未经授权的访问、使用或披露。然而，没有任何在线传输或电子存储方法是100%安全的。
							</p>

							<h2>5. 数据保留</h2>
							<p>
								我们会在实现本政策中概述的目的所需的时间内保留你的信息，除非法律要求或允许更长的保留期。
							</p>
							...
							<h2>9. 隐私政策更新</h2>
							<p>
								我们可能会不时更新本隐私政策。更新后的政策将在我们的网站上发布，并在重大变更时通知你。
							</p>
