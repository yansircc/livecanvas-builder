				...
				<main className="container flex-1 py-12">
					<div className="mx-auto max-w-4xl space-y-8 px-4">
						...
						<div className="prose prose-zinc dark:prose-invert max-w-none">
							<h2>1. 条款接受</h2>
							<p>
								通过访问和使用我们的服务，你确认你已阅读、理解并同意受这些条款的约束。如果你不同意这些条款的任何部分，你可能不会访问或使用我们的服务。
							</p>
							...
							<h2>3. 用户账户</h2>
							<p>
								使用我们的某些功能可能需要你创建账户。你有责任保护你的账户信息，并对你账户下发生的所有活动负责。我们保留拒绝服务、终止账户或删除内容的权利。
							</p>

							<h2>4. 用户内容</h2>
							<p>
								你保留你创建并上传到我们服务的内容的版权。然而，通过上传内容，你授予我们非排他性、全球性、免版税的许可，以使用、复制、修改、公开展示和分发你的内容。
							</p>

							<h2>5. 隐私政策</h2>
							<p>
								你使用我们服务的同时，也同意我们的隐私政策，该政策描述了我们如何收集、使用和共享你的信息。
							</p>
