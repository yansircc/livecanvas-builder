  ...
  return (
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="border-zinc-200 bg-white sm:max-w-[500px] dark:border-zinc-800 dark:bg-zinc-900">
        <DialogHeader className="border-zinc-200 border-b pb-4 dark:border-zinc-800">
          <DialogTitle className="font-semibold text-xl text-zinc-900 dark:text-zinc-100">
            编辑项目
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          ...
          <DialogFooter className="border-zinc-200 border-t pt-4 dark:border-zinc-800">
            <Button
              type="button"
              variant="outline"
              onClick={onClose}
